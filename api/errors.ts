...
export class UnauthorizedError extends ApiError {
  constructor(message: string = 'Authentication required', response?: ApiErrorResponse, originalError?: unknown) {
...
export class ForbiddenError extends ApiError {
  constructor(message: string = 'Access forbidden', response?: ApiErrorResponse, originalError?: unknown) {
...
export class NotFoundError extends ApiError {
  constructor(message: string = 'Resource not found', response?: ApiErrorResponse, originalError?: unknown) {
...
export class ConflictError extends ApiError {
  constructor(message: string = 'Resource conflict', response?: ApiErrorResponse, originalError?: unknown) {
...
export class ServerError extends ApiError {
  constructor(message: string = 'Internal server error', response?: ApiErrorResponse, originalError?: unknown) {
